...
const TransactionList = ({ transactions, onDeleteTransaction, onEditTransaction, settings, title, groupByDate = false }) => {
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="text-muted" style={{ fontSize: '0.85rem' }}>
          {!groupByDate && <span style={{ marginRight: '8px' }}>{new Date(t.date).toLocaleDateString('ja-JP', { month: 'short', day: 'numeric' })}</span>}
              ...
              return (
                <div key={date} className="mb-6">
                  ...
                  <div className="flex flex-col gap-2">
                    {dayTx.map(t => renderTransactionItem(t))}
                  </div>
                </div>
              );
            })
